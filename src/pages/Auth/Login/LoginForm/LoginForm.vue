<template>
  ...
  <div>
    ...
    <div class="form-group">
      ...
      <input id="email" type="email" /> <!-- [ngClass]="onSetInputClass('email')" formControlName="email" -->
    ...
    <div class="form-group">
      ...
      <input id="password" type="password" /> <!-- [ngClass]="onSetInputClass('password')" formControlName="password" -->
...
<script>
// import Form from '@/shared/Components/Loader/Loader.vue'
